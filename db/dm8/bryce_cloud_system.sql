...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (122, 'Sentinel控制台', 'M', 3, 'http://localhost:8858', 'monitor:sentinel:page', 'icon-sentinel', 1, 1, '流量控制菜单', 1, 1, null, 1, now(), 1, now());
