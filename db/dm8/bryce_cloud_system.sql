create schema if not exists bryce_cloud_system;
/*
    -- 删除表
...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (122, 'Sentinel控制台', 'M', 3, 'http://localhost:8718', 'monitor:sentinel:page', 'icon-sentinel', 1, 1, '流量控制菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (123, 'Nacos控制台', 'M', 3, 'http://localhost:8848/nacos', 'monitor:nacos:page', 'icon-nacos', 1, 1, '服务治理菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (124, 'Admin控制台', 'M', 3, 'http://localhost:9013/login', 'monitor:server:page', 'icon-linechart', 1, 1, '服务监控菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (131, '代码生成', 'M', 4, '{{apiUrl}}/system/generator-ui/index.html', 'generator:generator:page', 'icon-code', 1, 1, '代码生成菜单', 1, 1, null, 1, now(), 1, now());
