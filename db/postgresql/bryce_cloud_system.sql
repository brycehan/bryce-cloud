...
INSERT INTO brc_sys_role (id, name, code, data_scope, sort, status, remark, org_id, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (2, '普通角色', 'default', 2, 0, true, '普通角色', null, 1, false, 1, now(), null, null);
