...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (117, '地区编码', 'M', 2, 'system/areaCode/index', 'system:areaCode:page', 'icon-build', 0, 6, '地区编码菜单', 1, null, 1, now(), 1, now());
...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1171, '地区编码新增', 'B', 117,null, 'system:areaCode:save', '', 0, 1, null, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1172, '地区编码修改', 'B', 117, null, 'system:areaCode:update', '', 0, 2, null, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1173, '地区编码删除', 'B', 117, null, 'system:areaCode:delete', '', 0, 3, null, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1174, '地区编码详情', 'B', 117, null, 'system:areaCode:info', '', 0, 4, null, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1175, '地区编码导出', 'B', 117, null, 'system:areaCode:export', '', 0, 5, null, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1176, '地区编码导入', 'B', 117, null, 'system:areaCode:import', '', 0, 6, null, 1, null, 1, now(), 1, now());
